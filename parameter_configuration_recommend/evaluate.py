# -*- coding: utf-8 -*-
"""
Recommend the optimal configurations online for the given dataset and target recall rates
"""
...
from TD3 import *
from index_env import IndexEnv
...
if __name__ == '__main__':
    ...
    filename_dic = {'deep1': 'deep_1_1_96_1', 'sift1': 'sift_1_1_128_1', 'glove': 'glove_1_1.183514_100',
                    ...
                    'nytimes': 'nytimes_0_2.9_256', 'tiny': 'tiny_1_1_384', 'gist': 'gist_1_1.0_960',
                    'deep10': 'deep_2_1_96', 'sift50': 'sift_2_5_128_1', 'sift2': 'sift_1_2_128_1',
                    'sift3': 'sift_1_3_128_1', 'sift4': 'sift_1_4_128_1', 'sift5': 'sift_1_5_128_1',
    ...
    predict_model_save_path = os.path.join(parent_directory, 'query_performance_predict/model_checkpoints/{}/{}_{}_{}_{}_{}_{}_{}_checkpoint.pth'.format(
                                               mode, dataset_name, args_p.dipredict_layer_sizes, args_p.dipredict_n_epochs,
                                                    args_p.dipredict_batch_size, args_p.dipredict_lr, selected_num, selected_rounds))
    standard_path = os.path.join(parent_directory,'query_performance_predict/scaler_paras/{}/{}_feature_standard_{}_{}.npz'.format(
    ...
    feature_df = def_df[['SIZE', 'q_SIZE', 'DIM', 'LID', 'Sum_K_MinDist', 'Sum_K_MaxDist', 'Sum_K_StdDist',
    ...
    env = IndexEnv(num_dataset, final_default_performance, target_rec_lis, args_r, args_p,
