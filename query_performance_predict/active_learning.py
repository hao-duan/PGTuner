...
'''
This code is used to implement model transfer.
'''
...
def get_distance_statistics(min_distance):
...
if __name__ == '__main__':
    ...
    new_model_save_path = os.path.join(current_directory, 'model_checkpoints/{}/{}_{}_{}_{}_{}_{}_{}_checkpoint.pth'.format(mode, dataset_name,
                                                          args.dipredict_layer_sizes, args.dipredict_n_epochs,
    ...
    if dist_flag:
        ...
        for round_num in tqdm(range(selected_rounds), total = selected_rounds):
            ...
            whole_df_f = pd.concat([df_train_f, df_valid_f], axis=0)
            ...
            t1 = time.time()
            detected_labeled_feature = feature_df2feature_tensor(current_detected_df_feature_labeled, device, feature_scaler)
            detected_labeled_feature_vectors = get_feature_vectors(model, detected_labeled_feature)
