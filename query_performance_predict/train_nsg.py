...
if __name__ == '__main__':
    ...
    os.makedirs(os.path.join(current_directory, 'model_checkpoints/NSG_KNNG'), exist_ok=True)
    ...
    dipredict_model_save_path = os.path.join(current_directory, 'model_checkpoints/NSG_KNNG/{}_{}_{}_{}_checkpoint.pth'.format(
